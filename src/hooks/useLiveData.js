  ...
  async function fetchNews() {
    ...
    if (MEDIASTACK_KEY) {
      try {
        ...
        const url = `http://api.mediastack.com/v1/news?access_key=${MEDIASTACK_KEY}&keywords=${encodeURIComponent(keywords)}&countries=in,pk,cn,ir,il,ua,ru&languages=en&limit=50&sort=published_desc`;
